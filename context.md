...
> Read this first when returning to the project. Last updated: 2026-05-31 (M7b cascade + Scoring tab + Importance shipped).
...
| **M7c** Persist outcomes on submit + Grouped scoring | not started | Write `dnx_outcome` on submit, surface overall chip on the hero, implement Grouped scoring. |
