...
> Read this first when returning to the project. Last updated: 2026-05-30 (M7a question-level pass/fail rules shipped).
...
| **M7b** Rule cascade (Sub/Section/Assessment + Weighted/Grouped) | not started | Roll up question outcomes through scoring groups + weighted modes. Persist outcomes on submit. Hero summary chip. |
