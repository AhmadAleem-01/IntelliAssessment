...
> Read this first when returning to the project. Last updated: 2026-05-31 (M8a letter + M8c dashboard / threaded comments drawer / question tagging shipped).
...
| **M8c.3** Version history drawer | not started | Reviewer-facing UI over `dnx_assessment_versions` snapshots: chronological list with who/when/reason (Autosave / Submitted / Reopened / Approved), optional download of the snapshot JSON. |
