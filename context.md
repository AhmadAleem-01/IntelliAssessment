...
> Read this first when returning to the project. Last updated: 2026-05-31 (M7d grouped scoring shipped — M7 fully complete).
...
| **M8c** Dashboard + comments + version history surfacing | not started | Populate stub dashboard with real counts (In progress / Pending review / Complete / outcome breakdown). Surface comments and per-save snapshots in a reviewer-facing UI. |
