...
export const Contactsdnx_employeetype = {
  0: 'Employee',
  1: 'Client'
} as const;
export type Contactsdnx_employeetype = keyof typeof Contactsdnx_employeetype;
export const Contactsdnx_location = {
  0: 'Karachi',
  1: 'Lahore',
  2: 'Others'
} as const;
export type Contactsdnx_location = keyof typeof Contactsdnx_location;
export const Contactsdnx_relationship = {
  0: 'Father',
  1: 'Mother',
  2: 'Wife',
  3: 'Brother',
  4: 'Other_OnlyBloodRelatives'
} as const;
export type Contactsdnx_relationship = keyof typeof Contactsdnx_relationship;
...
export interface ContactsBase {
  ...
  department?: string;
  description?: string;
  "dnx_Approver@odata.bind"?: string;
  "dnx_department@odata.bind": string;
  dnx_employeetype: Contactsdnx_employeetype;
  "dnx_LineManager@odata.bind"?: string;
  dnx_location: Contactsdnx_location;
  dnx_relationship: Contactsdnx_relationship;
  "dnx_reportingmanager@odata.bind"?: string;
  "dnx_role@odata.bind": string;
  dnx_syncemployee?: boolean;
...
export interface Contacts extends ContactsBase {
  ...
  dnx_approvername?: string;
  dnx_approveryominame?: string;
  dnx_departmentname?: string;
  dnx_employeetypename?: string;
  dnx_linemanagername?: string;
  dnx_linemanageryominame?: string;
  dnx_locationname?: string;
  dnx_relationshipname?: string;
  dnx_reportingmanagername?: string;
  dnx_reportingmanageryominame?: string;
  dnx_rolename?: string;
  dnx_syncemployeename?: string;
  ...
  dnx_approver?: object;
  _dnx_approver_value?: string;
  dnx_department?: object;
  _dnx_department_value?: string;
  dnx_linemanager?: object;
  _dnx_linemanager_value?: string;
  dnx_reportingmanager?: object;
  _dnx_reportingmanager_value?: string;
  dnx_role?: object;
  _dnx_role_value?: string;
  masterid?: object;
