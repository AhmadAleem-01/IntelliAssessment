...
const useStyles = makeStyles({
  ...
  editor: {
    ...
    outline: 'none',
    cursor: 'text',
    ':focus': { border: '1px solid var(--ds-ai-primary, #8B5CF6)' },
    ':empty::before': {
  ...
  slashItemActive: { backgroundColor: 'var(--ds-ai-surface, #F5F3FF)' },
  slashItemLabel: { fontSize: '13px', fontWeight: 500 },
  slashItemPath: { fontSize: '10px', color: 'var(--ds-text-muted)' },
});
